...
<p>
<a href="https://axcora.com/getaxcoracms/index.php?id=get-started" class="mdl-button mdl-js-button mdl-button--raised mdl-button--accent">Documentation</a>
<a href="https://axcora.com/getaxcoracms/index.php?id=new-website-template-themes" class="mdl-button mdl-js-button mdl-button--raised mdl-button--accent">Free Themes</a>
<a href="https://axcora.com/getaxcoracms/index.php?id=free-template-website-download" class="mdl-button mdl-js-button mdl-button--raised mdl-button--accent">Premium Themes</a>
</p>
<p>
