...
<div class="container">
	...
	<div id="maincontent row">
		...
		<div class="main col-12 col-md-8 p-3 p-md-5">
			...
			<h3>PERS TV AREA</h3>
<p>
<a href="theme-edit.php?f=widget%2Fsection2%2Fperstitle.php&s=Edit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">Pers TV Title</a>
<a href="theme-edit.php?f=widget%2Fsection2%2Fperspost.php&s=Edit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">Pers TV Content</a>
<a href="theme-edit.php?f=widget%2Fsection2%2Fperscover.php&s=Edit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">Pers TV Cover</a>
<a href="theme-edit.php?f=widget%2Fsection2%2Fpersurl.php&s=Edit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">Pers TV URL</a>
</p>
</div>
